...
{% asset_img refund1.png [退款工单回复，提示中国区无法使用G Suite] %}
...
{% asset_img gongdan4.png [登不进去账号，只能通过邮件截图之前发过的工单] %}
...
{% asset_img cantlogin.png [账号被锁定] %}

第二天上午，我收到了工单的回复，提示我需要再次验证账号身份。

{% asset_img gongdan2.png [工单回复要求验证账号身份（邮件太长只截图一部分）] %}
...
{% asset_img accountrecovermail.png [意思就是继续等审核结果] %}

第二天晚上，收到了最终回复，账号不予解封，白嫖我个人信息，气死了。

{% asset_img result.png [不予解封] %}
...
{% asset_img v2ex1.png [v2ex上对于dynadot的评价] %}

{% asset_img v2ex2.png [v2ex上对于dynadot的评价] %}

{% asset_img bijiao1.png [域名转移相关的比较] %}

{% asset_img bijiao2.png [安全性相关的比较] %}
...
{% asset_img error.png [我点续费选项后也没让我选续费时长呀] %}
